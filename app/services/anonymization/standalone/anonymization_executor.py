...
class AnonymizationExecutor:
    ...
    def anonymize_activities(self, mission_ids: Set[int]) -> None:
        ...
        result = self.db.execute(
            text(
                """
                INSERT INTO anon_activity
                    (id, type, user_id, submitter_id, mission_id,
                     creation_time, start_time, end_time, last_update_time)
    ...
    def anonymize_activity_versions(self, mission_ids: Set[int]) -> None:
        ...
        result = self.db.execute(
            text(
                """
                INSERT INTO anon_activity_version
                    (id, creation_time, activity_id, start_time, end_time,
                     version_number, submitter_id)
        ...
        self.log_anonymization(result.rowcount, "activity version")
    ...
    def anonymize_mission_ends(self, mission_ids: Set[int]) -> None:
        ...
        result = self.db.execute(
            text(
                """
                INSERT INTO anon_mission_end
                    (id, creation_time, mission_id, user_id, submitter_id)
        ...
        self.log_anonymization(result.rowcount, "mission end")
    ...
    def anonymize_mission_validations(self, mission_ids: Set[int]) -> None:
        ...
        self.log_anonymization(result.rowcount, "mission validation")
    ...
    def anonymize_location_entries(self, mission_ids: Set[int]) -> None:
        ...
        result = self.db.execute(
            text(
                """
                INSERT INTO anon_location_entry
                    (id, submitter_id, type, creation_time, mission_id,
                     address_id, company_known_address_id)
        ...
        self.log_anonymization(result.rowcount, "location entry")
    ...
    def anonymize_missions(self, mission_ids: Set[int]) -> None:
        ...
        result = self.db.execute(
            text(
                """
                INSERT INTO anon_mission
                    (id, creation_time, submitter_id, company_id)
